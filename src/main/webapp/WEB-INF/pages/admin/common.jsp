...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
    ...
    <link href="${project}/resources/css/bootstrap.css" rel='stylesheet' type='text/css' />
    <link href="${project}/resources/fonts/css/font-awesome.min.css" rel="stylesheet" >
    <!-- text fonts -->
    <link href="${project}/resources/fonts/css/ace-fonts.css" rel="stylesheet"/>
    <link href="${project}/resources/fonts/css/ace.css" rel="stylesheet"  />
